document.addEventListener('DOMContentLoaded', () => {
  ...
  responsiveStyle.textContent = `
    ...
    .github-photo{width:clamp(170px,17vw,220px);height:clamp(170px,17vw,220px);border-radius:50%;object-fit:cover;display:block;border:1px solid rgba(125,211,252,.35);box-shadow:0 0 0 8px rgba(56,189,248,.035),0 25px 70px rgba(0,0,0,.4);position:relative;z-index:2}
    .profile-photo-wrap{position:absolute;right:-28px;top:-70px;width:clamp(190px,19vw,245px);height:clamp(190px,19vw,245px);display:grid;place-items:center;z-index:3;pointer-events:none}
    .profile-photo-wrap:before{content:"";position:absolute;inset:4%;border:1px solid rgba(56,189,248,.18);border-radius:50%;animation:photoPulse 4s ease-in-out infinite}
    .profile-photo-wrap:after{content:"GITHUB PROFILE";position:absolute;right:2px;bottom:-6px;padding:5px 8px;border:1px solid rgba(56,189,248,.2);background:#0b1220;color:#7dd3fc;border-radius:999px;font:700 8px monospace;letter-spacing:.12em}
    @keyframes photoPulse{50%{transform:scale(1.04);opacity:.55}}
  ...
  // Inline LinkedIn brand mark: no external icon dependency.
